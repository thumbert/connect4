...
#[allow(dead_code)]
fn minimax_strategy2(state: &State) -> Move {
...
#[allow(dead_code)]
fn minimax_strategy3(state: &State) -> Move {
    let mut rng = rand::thread_rng();
    ...
    let candidates: Vec<_> = values.iter().enumerate()
...
#[allow(dead_code)]
fn minimax_strategy4(state: &State) -> Move {
...
#[allow(dead_code)]
fn minimax_strategy5(state: &State) -> Move {
...
#[allow(dead_code)]
fn minimax_strategy6(state: &State) -> Move {
...
//         if self.current.kind == StateKind::Final {
//             return None;
//         }
//         let current_state = &self.current;
//         let current_player = if &self.current.moves_player1.len() == &self.current.moves_player2.len() {
//             &self.current.player1
//         } else {
//             &self.current.player2
//         };

//         let m = (current_player.strategy)(&self.current);
//         println!("{} moves to {}", current_player.name, m);
//         let state2 = current_state.result(m);
//         println!("{:?}", state2);
//         println!("Exiting next");
